...
export const getDecryptedMessagesFromOutbox = async (outbox: OutboxMessage[], currentAccount: Account): Promise<OutboxMessage[]> => {
...
export default getDecryptedMessagesFromOutbox;
