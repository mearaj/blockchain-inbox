...
import {INBOX_ENDPOINT, INBOX_RENEW_LEASE_ENDPOINT, SENT_ENDPOINT} from 'config';
...
import {deleteMessageController, getMessagesController} from 'controllers/messages';
