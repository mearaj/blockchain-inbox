/**
 *  These are environmental variables. If environment is production you just need to set
 *  process.env.NODE_ENV,
 *  process.env.ENDPOINT,
 *  process.env.PORT,
 *  process.env.MONGO_URI
 *  on the deployed server, example Heroku
 */
...
export const OUTBOX_RENEW_LEASE_ENDPOINT = `${OUTBOX_ENDPOINT}/renew`;
