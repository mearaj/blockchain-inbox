...
export const INBOX_RENEW_LEASE_ENDPOINT = `${ENDPOINT}/inbox/renew`;
export const OUTBOX_ENDPOINT = `${ENDPOINT}/outbox`;
export const OUTBOX_RENEW_LEASE_ENDPOINT = `${ENDPOINT}/outbox/renew`;
export const CLAIM_ENDPOINT = `${ENDPOINT}/claim`;
export const SENT_ENDPOINT = `${ENDPOINT}/sent`;
export const SENT_RENEW_LEASE_ENDPOINT = `${ENDPOINT}/sent/renew`;
